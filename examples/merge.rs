// we will use a nightly feature to gain a boost in read speed of PDF's"
#![feature(extend_one)]
...
// If you are ever having issues Reading new PDF from file please disable the Defaults for the library and enable
// nom, rayon and chrono packagas and features.
// lopdf = { version = "0.27.0", default-features = false , features = ["rayon", "nom_parser", "chrono_time"] }
